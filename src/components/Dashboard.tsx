          ...
          <div className="space-y-4">
            {recentInquiries.map((inquiry) => (
              <motion.button
                ...
                className="w-full bg-ui-card p-6 rounded-2xl shadow-sm border border-ui-border flex items-center justify-between group hover:shadow-md transition-all text-left"
              >
                <div>
